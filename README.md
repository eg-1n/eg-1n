...
<h4 align="left" weight="light">안녕하세요 👋, 저는 신예인 (SHIN YE IN)입니다</h4>
<h6 align="left" weight="light">경험을 설계하고 능력을 더하는 가변형 UX/UI 디자이너. (경험을 만들고 감성을 더하는 실용적인 UX/UI 디자이너입니다.)
